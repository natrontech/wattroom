...
| [0032](0032-a-gif-picker-proxied-through-the-server.md) | The GIF picker is Tenor, proxied, and it posts a plain chat message | accepted | Answers the picker #279 parked. Stickers stay open ([#879](https://github.com/natrontech/wattroom/issues/879)) |
