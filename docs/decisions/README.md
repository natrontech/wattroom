...
| [0015](0015-self-hosted-music-pool.md) | Self-hosted music pool — uploaded MP3s join the jukebox | accepted, **built** 2026.09.43–.45 (#266, #268, #267) | Amends WATTROOM.md's Jukebox row. Library playlists, saved playlists and pasted ones are distinct: [0028](0028-room-and-personal-playlists.md). Its storage paragraph reserved `playlists`/`playlist_tracks`, which #628 has since taken for YouTube — [#655](https://github.com/natrontech/wattroom/issues/655) decides what pool playlists get called |
