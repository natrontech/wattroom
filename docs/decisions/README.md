...
| [0015](0015-self-hosted-music-pool.md) | Self-hosted music pool — uploaded MP3s join the jukebox | accepted, not yet built (#264, #268) | Amends WATTROOM.md's Jukebox row. Library playlists, saved playlists and pasted ones are distinct: [0028](0028-room-and-personal-playlists.md) |
...
| [0028](0028-room-and-personal-playlists.md) | Save playlists for rooms and riders; autoplay only an idle deck | accepted | Distinguishes saved playlists from pasted YouTube playlists ([0026](0026-a-playlist-is-one-queue-entry.md)) and the unbuilt music-pool library ([0015](0015-self-hosted-music-pool.md)) |
