...
| [0031](0031-the-server-unfurls-links-riders-paste.md) | The server unfurls links riders paste, behind a pinned-address fetch | accepted | Builds on [0009](0009-login-gated-app.md). Replaces the browser-only oEmbed note in `LinkPreview.svelte` |
