...
- Revisit when the self-hosted pool ([ADR-0015](0015-self-hosted-music-pool.md), #264/#268) brings library playlists. Those are a stored, editable object; this is a snapshot of somebody's link. They share a word and should not share a type. _Revisited by [ADR-0045](0045-a-saved-playlist-is-a-saved-queue.md): the stored object is the saved room or personal playlist, and one of its entries may be this snapshot._
