...
| #1961 | The toast's Undo is unreachable by keyboard and expires under the rider                                         | high     | 2.1.1, 2.2.1 | fixed (#1974): a live region after the skip link, undo toasts stay, timers hold under the pointer |
| #1962 | The `@` mention list is not a real combobox                                                                     | bug      | 4.1.2        | fixed (#1972)                                                                                     |
| #1963 | The soundboard's rename field is nested inside the pad button; its delete confirm takes no focus                | bug      | 4.1.2, 2.4.3 | fixed (#1975)                                                                                     |
| #1964 | A fader inside a context menu is not a menu item                                                                | bug      | 4.1.2        | fixed (#1972)                                                                                     |
| #1965 | The accent tokens are used as 10–11 px text, below 4.5:1                                                        | bug      | 1.4.3        | fixed (#1976): the accent stays on the mark, the words in ink                                     |
| #1966 | Colour-only states get a name — presence on the avatar, a pressed reaction, the gate meter                      | bug      | 1.4.1, 4.1.2 | fixed (#1972)                                                                                     |
| #1967 | A chosen day and a rejected time in the when-picker are announced                                               | bug      | 4.1.2, 3.3.1 | fixed (#1975)                                                                                     |
...
| #1969 | Escape closes every layer at once; the open drawer keeps no focus                                               | bug      | 3.2.2, 2.4.3 | fixed (#1974)                                                                                     |
