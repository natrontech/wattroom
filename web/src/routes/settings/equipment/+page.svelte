...
<!-- The Equipment section of Settings (#1330): the sensors, and the test
     that sets the number they are scored against. -->
<div>
	<h2 class="font-display mt-8 text-xl font-bold">Sensors</h2>
