...
/**
 * Rooms made before #447 stored emoji, and a client from before it still
...
/**
 * The component that draws `value` — an icon key or an emoji saved before
 * #447. Nothing for '', a placeholder for a value nobody knows.
 */
