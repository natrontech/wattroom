<script lang="ts">
	...
	import {
		...
		IN_SYNC_SEC,
		playerInfo,
	} from '$lib/channel/jukebox-player.svelte';
	import { listening } from '$lib/channel/listening.svelte';
	import { clampSeek, playheadAt } from '$lib/channel/playhead';
	import { serverNow } from '$lib/server-clock';
	import { offerSeat, RAIL_SEAT } from '$lib/channel/stage-slot.svelte';
