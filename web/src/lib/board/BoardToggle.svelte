<script lang="ts">
	/**
	 * The way to the soundboard, in the voice channel's reaction row.
	 *
	 ...
	 * speaker glyph sat beside the mix faders and read as a second volume control
	 * while taking a third of a 240 px row. Firing a clip is what a cheer is —
	 * something you throw into the voice channel — so it lives with the cheers
	 * and draws a drum, not a speaker.
	 *
