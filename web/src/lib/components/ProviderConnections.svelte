<script lang="ts">
	...
	// Retry means the whole OAuth round trip again, so it is offered only for a
	// provider this server actually has credentials for (`ux.md`): a hand-typed
	// ?link=failed carries no provider, and that button would 404.
